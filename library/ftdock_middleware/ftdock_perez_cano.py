...
class FtdockPerezCano(object):
    # def perez_cano_rankings(self,matrix_file):
    def perez_cano_rankings(self):
        ...
        for ftdockedpdbfile in ftdocked_pdb_files:
            ...
            # os.system("./rpscore -in ~/bioresearch/compbio/files_wip/ftdockresults/%s -out ~/bioresearch/compbio/files_wip/perez_cano_rankings/%s.perez_cano_scored > ~/bioresearch/compbio/logs/rpscore &" %(ftdockedpdbfile,ftdockedpdbfile))
            time.sleep(60)
...
FtdockPerezCano().perez_cano_rankings()
